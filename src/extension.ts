...
export function activate(context: vscode.ExtensionContext) {	
	...
	function doTheIndentOutdentThing(blIndent: boolean){
	...
	function indentLine (passedLine: string, passedPattern: string){
	...
	function outdentLine (passedLine: string, passedPattern: string){
		var strLine = passedLine;
		var strRetLine;
		//Getting the leading Spaces
		var intLeadingOffset = strLine.search(/\S/);
	...
	function normalizeString (passedString: string){
